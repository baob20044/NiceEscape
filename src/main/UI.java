...
public class UI {
    ...
    public void drawPlayScreen() {
        ...
        g2.setFont(arial_20);
        g2.setColor(Color.WHITE);
        String text1 = "Time: " + gp.getAchiveTime() / 60;
    ...
    public void drawFinishedScreen() {
        ...
        text = gp.getName() + " get a Nice Escape";
        ...
        g2.drawString(text, x, y);
        //
        text = "Your time is : " + gp.getAchiveTime()/60 + "!";
        textLength = (int) g2.getFontMetrics().getStringBounds(text, g2).getWidth();
        x = gp.getScreenWidth() / 2 - textLength / 2;
    ...
    public void drawTitleScreen() {
        ...
        text = "Made by: Đinh Quốc Bảo & Trần Minh Hiếu";
    ...
    public void drawPauseScreen() {
        ...
        g2.setColor(new Color(0, 126, 135));
        text = "Press S to save game";
        x = gp.getTileSize() * 13;
        y = gp.getTileSize() * 1;
        g2.drawString(text, x, y);

        text = "Press Q to return menu";
        x = gp.getTileSize() - 10;
        y = gp.getTileSize() * 1;
        g2.drawString(text, x, y);
